...
const MAP_ISLANDS: MapIslandNode[] = [
  {
    ...
    subtitle: 'Bước chân vào ĐH Khoa học Tự nhiên',
    coord: { x: 14, y: 62 },
    icon: '🎓',
    color: 'from-amber-400 to-orange-500',
    accent: '#f59e0b',
    codeSnippet: `// HCMUS Computer Vision & OOP\n#include <SFML/Graphics.hpp>\nclass ChessGame : public BoardGame {\n  void handlePlayerMove();\n};`,
    lore: 'Bắt đầu hành trình học tập tại Khoa CNTT - ĐH Khoa học Tự nhiên ĐHQG-HCM. Xây dựng nền tảng IT thông qua các dự án về lập trình C++, Game Cờ vua, SFML, và đồng hành cùng VietHope trong vai trò Designer & Video Editor.',
  ...
  },
  {
    ...
    subtitle: 'Remote Desktop Socket TCP/IP & Thuật toán tìm kiếm ',
    coord: { x: 33, y: 32 },
    icon: '⚡',
    color: 'from-pink-500 to-rose-500',
    accent: '#f43f5e',
    codeSnippet: `// Java Socket TCP/IP Server\nServerSocket server = new ServerSocket(8888);\nSocket client = server.accept();\nRobot robot = new Robot(); // Screen capture & input control`,
    lore: 'Thực hiện dự án lập trình mạng client-server điều khiển máy tính từ xa qua Java Socket và PowerShell. Triển khai các giải thuật tìm kiếm không gian trạng thái kinh điển: A*, BFS, DFS, thông qua các Game như Pacman, Wumpus,...',
  ...
  },
  {
    ...
    subtitle: 'Phát triển UI, AI Chatbot cho Công ty thời trang',
    coord: { x: 53, y: 64 },
    icon: '💎',
    ...
    lore: 'Gia nhập Ortho Fashion và đi từ thực tập sinh lên Frontend Developer. Trực tiếp xây dựng UI và tích hợp AI, kết nối ví Web3 MetaMask. Tự xây dựng Taskify App bằng React + TypeScript.',
  ...
  },
  {
    id: 'island-2025',
    year: '2025',
    title: 'Hoàn thành Khóa Luận • CatVTON & Kidspire',
    subtitle: 'Tốt nghiệp GPA 8.35/10, Tuyển thẳng Thạc sĩ & STEM Facilitator',
    coord: { x: 72, y: 28 },
    icon: '👑',
    ...
    lore: 'Hoàn thành khóa luận tốt nghiệp ứng dụng Deep Learning Virtual Try-On kết hợp CatVTON, DeepLabV3 phân đoạn và đổi màu y phục bằng câu lệnh văn bản. Tốt nghiệp với GPA 8.35/10 và trở thành điều phối STEM & SEL cho hơn 740 học sinh.',
  ...
  },
  {
    ...
    lore: 'Sẵn sàng mở rộng kiến thức về Full-Stack, Web tương tác 3D và On-device AI. Sẵn sàng mang tư duy kỹ thuật chỉn chu, tinh thần trách nhiệm cao và khả năng học hỏi nhanh vào môi trường công nghệ chuyên nghiệp.',
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-3 border-b border-white/30 dark:border-slate-700/60 z-10">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-xs sm:text-sm font-black text-slate-800 dark:text-white uppercase tracking-wider">
                    HẢI ĐỒ ĐẠI DƯƠNG AETHERIA • NHẤP VÀO ĐẢO ĐỂ THUYỀN GIƯƠNG BUỒM
                  </h3>
                </div>
